...
class Worker:
    ...
    def define_networks(self):
        ...
        summary_fine_reconstruction = tf.summary.image("fine_scale", tf.concat([self.fine_scale[:, :, :, :3], deconv2_fine[:, :, :, :3]], axis=2), max_outputs=1)
        summary_coarse_reconstruction = tf.summary.image("coarse_scale", tf.concat([self.coarse_scale[:, :, :, :3], deconv2_coarse[:, :, :, :3]], axis=2), max_outputs=1)
